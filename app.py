...
def generar_pdf_clinico(datos):
    ...
    # 3. Antecedentes Clínicos (Distribución en Columnas simulada)
    ...
    consent_body = (
        ...
        "(Aquí el sistema incluye el texto íntegro solicitado anteriormente)..."
    )
...
# PÁGINA 2: CUESTIONARIO (BLOQUEADO)
...
# PÁGINA 3: CONSENTIMIENTO TEXTUAL (TEXTO ÍNTEGRO BLOQUEADO)
...
# PÁGINA 4: EMISIÓN PDF PROFESIONAL
