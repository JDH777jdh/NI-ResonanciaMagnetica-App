...
st.markdown(
    """
    <style>
    /* Hace que el texto dentro de la lista desplegable abierta se ajuste en varias líneas */
    ...
    /* Opcional: Hace que el texto seleccionado (cuando el menú está cerrado) también se ajuste si es muy largo */
