...
# --- PÁGINA 4: FINALIZACIÓN ---
    ...
    # ─── BLOQUE INFORMATIVO CORREGIDO (SIN ESPACIOS NI TABULACIONES INTERNAS) ───
    texto_html = (
        "<div style='background-color: #e3f2fd; padding: 18px; border-radius: 8px; "
        "border-left: 5px solid #2196f3; margin-bottom: 20px;'>"
        "<h4 style='color: #0d47a1; margin-top: 0; margin-bottom: 8px;'>📋 Cuestionario en Custodia Segura</h4>"
        "<p style='color: #1565c0; font-size: 15px; margin-bottom: 5px;'>"
        "Sus antecedentes y firma digital han sido respaldados en la base de datos central del hospital."
        "</p>"
        "<p style='color: #1c3d5a; font-size: 13.5px; margin-bottom: 0;'>"
        "<b>¿Qué viene ahora?</b> Por favor, tome asiento. El Tecnólogo Médico revisará y validará internamente "
        "esta encuesta en su estación de trabajo antes de llamarlo a su examen."
        "</p>"
        "</div>"
    )
