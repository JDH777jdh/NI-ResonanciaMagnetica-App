...
# =================================================================
# 3. UTILITARIOS DE VALIDACIÓN TÉCNICA
# =================================================================
...
if st.session_state.step == 1:
    ...
    # Simulación de DB cargada
    db = pd.read_csv('listado_prestaciones.csv') if os.path.exists('listado_prestaciones.csv') else None
    if db is not None:
