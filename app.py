...
if st.session_state.step == 1:
    ...
    st.session_state.form["condiciones"] = st.multiselect("Seleccione todas las que correspondan y detalle:", opciones_condicion, default=st.session_state.form.get("condiciones", []))
