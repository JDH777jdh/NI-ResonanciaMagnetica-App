...
# =============================================================================
    ...
    if ruta_firma_storage_final:
        try:
            ...
            # =====================================================================
            # 🩹 CORRECCIÓN NIVEL DIOS: SUBIR LA ENCUESTA COMPLETA SIN MUTILARLA
            # =====================================================================
            # 1. Clonamos el formulario base con sus 47 respuestas clínicas crudas
            ...
            payload_firestore.update({
                ...
                "ip_dispositivo": str(st.session_state.get("ip_dispositivo", "IP No detectada")),
