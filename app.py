...
if st.session_state.step == 1:
    ...
    if df is not None:
        ...
        with c1:
            ...
            # LÓGICA DE GÉNERO Y SEXO BIOLÓGICO
...
# --- PÁGINA 2: CUESTIONARIO REESTRUCTURADO ---
    ...
    st.session_state.form["bio_implantes"] = c2.radio("Implantes metálicos, quirúrgicos, prótesis o dispositivos electrónicos:", opts, index=opts.index(st.session_state.form["bio_implantes"]), horizontal=True)
...
# --- PÁGINA 3: CONSENTIMIENTO INFORMADO TEXTUAL ---
    ...
    if st.session_state.tiene_contraste:
        ...
        Autorizo la realización del procedimiento anteriormente especificado y las acciones que sean necesarias en caso de surgir complicaciones durante el procedimiento. Además, doy consentimiento para que se administren medicamentos y/o infusiones que se requieran para la realización de este.<br><br>
        ...
        """, unsafe_allow_html=True)
        st.session_state.form["autoriza_gad"] = st.radio("¿Autoriza el procedimiento y administración de contraste?", ["SÍ", "NO"], index=None)
    else:
...
# --- PÁGINA 4: PDF ---
    ...
    if st.button("Descargar PDF de Registro (Compilado)"):
        st.info("Generando PDF con todos los datos y consentimiento...")
