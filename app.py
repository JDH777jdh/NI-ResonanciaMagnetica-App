...
if not firebase_admin._apps:
    try:
        ...
        if "private_key" in cred_dict and isinstance(cred_dict["private_key"], str):
            ...
            # 1. Extraer solo el contenido Base64 ignorando los encabezados
            b64_content = re.sub(r'-----.*?PRIVATE KEY-----', '', raw_key)
            # 2. Limpiar cualquier espacio, salto de línea o basura invisible
            b64_content = re.sub(r'\s+', '', b64_content)
            # 3. Reconstruir matemáticamente bloques exactos de 64 caracteres
