...
if not firebase_admin._apps:
    try:
        ...
        if "private_key" in cred_dict and isinstance(cred_dict["private_key"], str):
            ...
            # 1. Aislar el contenido Base64 quitando los encabezados
            b64_content = re.sub(r'-----.*?PRIVATE KEY-----', '', raw_key)
            # 2. Remover absolutamente todos los saltos de línea y espacios remanentes
            b64_content = re.sub(r'\s+', '', b64_content)
            # 3. Fragmentar en líneas perfectas de 64 caracteres (Estándar PEM exigido)
