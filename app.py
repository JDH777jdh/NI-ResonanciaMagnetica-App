...
def generar_pdf_clinico(datos):
    ...
    # NUEVA PÁGINA: INFORMACIÓN PARA EL PACIENTE (Punto 1 y 4 Modificado)
    pdf.add_page()
    ...
    # TEXTO LEGAL SOLICITADO (Punto 4)
    pdf.set_font('Arial', '', 9)
    ...
    # RECUADRO DE FIRMAS (Punto 3: Alineación mejorada)
    y_pos = pdf.get_y()
    if datos['firma_img']:
        # Se ajusta la posición de la imagen para que quede centrada sobre la línea (Punto 3)
...
if st.session_state.step == 1:
    ...
    if df is not None:
        ...
        # Punto 2: Carga de exámenes anteriores
...
# --- PÁGINA 3: INFORMACIÓN Y OBJETIVOS (Punto 1 y 4 Solicitado) ---
