...
st.markdown(
    ...
    /* Estilo botones sub-pestañas: Colores sólidos */
    .btn-opcion {
    ...
    .op-wa { background-color: #25D366 !important; } /* Verde WhatsApp */
    .op-tel { background-color: #0056b3 !important; } /* Azul Clínico */
    .op-mail { background-color: #800020 !important; } /* Burdeos Corporativo */

    /* Botón principal: Verde vibrante */
    .btn-principal {
    ...
    <div class="menu-flotante">
        <div class="opciones-contacto">
            ...
            <a class="btn-opcion op-tel" href="javascript:void(0)">
                📞 A. Fernández (Sin número)
            </a>
            ...
            <a class="btn-opcion op-wa" href="javascript:void(0)">
