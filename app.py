...
if 'form' not in st.session_state:
    st.session_state.form = {
        "rut": "", "sin_rut": False, "tipo_doc": "Pasaporte", "num_doc": "",
        "nombre": "", "genero_idx": 0, "sexo_bio_idx": 0,
...
if st.session_state.step == 1:
    ...
    if df is not None:
        ...
        with col1:
            # Lógica de Identificación Alternativa
            ...
            if not sin_rut:
                ...
                st.session_state.form["num_doc"] = "" # Limpia si vuelve a RUT
            else:
                ...
                st.session_state.form["rut"] = "" # Limpia si usa documento
...
# ---------------------------------------------------------
    ...
    st.download_button(label="📥 Descargar Resumen en PDF", data=pdf_bytes, file_name=f"Registro_NI.pdf", mime="application/pdf")
