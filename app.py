...
st.markdown(
    ...
    @keyframes pulse-glow {
        0% { box-shadow: 0 0 0 0 rgba(128, 0, 32, 0.4); }
        70% { box-shadow: 0 0 0 15px rgba(128, 0, 32, 0); }
        100% { box-shadow: 0 0 0 0 rgba(128, 0, 32, 0); }
    }

    /* Contenedor principal: pointer-events: none evita que bloquee clics en la app */
    .menu-flotante {
        position: fixed;
        bottom: 85px; 
        right: 15px;
    ...
    .opciones-contacto {
        ...
        pointer-events: auto; /* Reactiva los clics solo aquí */
    }

    /* Soporte para dispositivos móviles (focus) y PC (hover) */
    ...
    .btn-principal {
        ...
        gap: 8px;
        border: 1px solid rgba(255,255,255,0.2);
        pointer-events: auto; /* Reactiva los clics aquí */
    }
    </style>
