...
# --- PÁGINA 1: REGISTRO ---
if st.session_state.step == 1:
    # 1. CAPTURA DE IP BLINDADA (Evita el bucle de recarga que anula el botón CONTINUAR)
    if "ip_dispositivo" not in st.session_state.form or st.session_state.form["ip_dispositivo"] in ["Buscando IP...", "Cargando..."]:
