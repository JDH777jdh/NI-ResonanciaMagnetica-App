...
class PDF(FPDF):
    def header(self):
        ...
        # Título automático para todas las páginas alineado a la derecha ('R')
        self.set_font('Arial', 'B', 14)
        self.set_text_color(128, 0, 32)
        self.cell(0, 10, 'ENCUESTA Y CONSENTIMIENTO INFORMADO', 0, 1, 'R')
        
        # Subtítulo automático alineado a la derecha ('R')
        self.set_font('Arial', 'B', 12)
        self.cell(0, 5, 'RESONANCIA MAGNETICA', 0, 1, 'R')
        self.ln(10)
