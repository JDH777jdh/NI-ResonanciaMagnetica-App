...
st.markdown(
    """
    <style>
    /* Efecto de pulso (mantiene el color Burdeos transparente) */
    ...
    /* Estilo de botones: Mismo color Burdeos, fondo transparente */
    .btn-opcion {
        background-color: rgba(128, 0, 32, 0.6) !important; /* Burdeos transparente */
    ...
    <div class="menu-flotante">
        <div class="opciones-contacto">
            ...
            <a class="btn-opcion" href="javascript:void(0)" style="cursor: default; opacity: 0.7;">
