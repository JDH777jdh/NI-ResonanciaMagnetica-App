...
st.markdown(
    """
    <style>
    /* Efecto de pulso solo para el botón principal */
    ...
    /* Lista de los botones ocultos (AHORA SON 4) */
    .opciones-contacto {
        display: flex;
        flex-direction: column;
        gap: 10px;
    ...
    /* Magia: Al hacer hover sobre el contenedor, mostramos las opciones */
    ...
    /* Estilo general de los sub-botones */
    .btn-opcion {
        color: #ffffff !important; 
    ...
    .btn-opcion:hover { transform: scale(1.05); }

    /* Colores específicos para cada red */
    .op-wa { background-color: #25D366; }
    .op-tel { background-color: #0056b3; } /* Azul clínico para ambos teléfonos */
    .op-mail { background-color: #800020; } 
    ...
    <div class="menu-flotante">
        <div class="opciones-contacto">
            <a class="btn-opcion op-mail" href="mailto:resonancia@norteimagen.cl?subject=Duda%20Registro%20Resonancia" target="_blank">
                ✉️ Enviar Correo
            </a>
            <a class="btn-opcion op-tel" href="tel:+56572466423" target="_blank">
                📞 Llamar Sucursal Francisco Bilbao - Edificio Terranova
            </a>
            <a class="btn-opcion op-tel" href="tel:+56911111111" target="_blank">
                📞 Llamar Sucursal Arturo Fernandez
            </a>
            <a class="btn-opcion op-wa" href="https://wa.me/569XXXXXXXX?text=Hola%20Norte%20Imagen,%20tengo%20una%20duda%20con%20mi%20registro" target="_blank">
                📱 Chat WhatsApp
            </a>
        </div>
        
        <div class="btn-principal" title="¿Dudas o consultas acerca de tu Resonancia Magnética? Escríbenos">
            💬 Soporte
        </div>
    </div>
    """,
