...
def subir_a_google_drive(archivo_datos, nombre_archivo):
    try:
        # 1. Define la ruta de una carpeta en tu computador que se sincronice con Drive
        # Ejemplo: 'C:/Usuarios/TuNombre/Google Drive/Mi unidad/Examenes_RM'
        ruta_carpeta_sincronizada = "D:\Documentos  EC-RM" # <--- Cambia esto a tu ruta real
        ...
        # Google Drive para Escritorio detectará el archivo y lo subirá solo.
