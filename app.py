...
if df is not None:
    ...
    with c2:
        ...
        st.file_uploader("Cargue la Orden Médica...", type=["pdf", "jpg", "jpeg"], key="up_orden_p1")
        st.file_uploader("Cargue Exámenes Anteriores...", type=["pdf", "jpg", "jpeg"], accept_multiple_files=True, key="up_anteriores_p1")
