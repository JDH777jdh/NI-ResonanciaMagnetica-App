...
# --- PÁGINA 4: FINALIZACIÓN ---
    ...
    # ─── BLOQUE INFORMATIVO PARA GESTIÓN HOSPITALARIA ───
    st.markdown(
        """
        <div style='background-color: #e3f2fd; padding: 18px; border-radius: 8px; border-left: 5px solid #2196f3; margin-bottom: 20px;'>
            ...
            <p style='color: #1c3d5a; font-size: 13.5px; margin-bottom: 0;'>
                <b>¿Qué viene ahora?</b> Por favor, tome asiento. El Tecnólogo Médico revisará y validará internamente esta encuesta en su estación de trabajo antes de llamarlo a su examen.
            </p>
        </div>
        """, 
        unsafe_html=True
