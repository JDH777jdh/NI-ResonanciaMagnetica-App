...
def subir_a_google_drive(archivo_datos, nombre_archivo):
    try:
        ...
        # --- ESTA ES LA LÍNEA QUE DEFINE 'info' ---
        info = dict(st.secrets["gcp_service_account"])
        
        # Limpieza de la llave (ignora cualquier basura antes de los guiones)
        ...
        # Ahora sí, usamos 'info' para las credenciales
        ...
        # --- LLAMADA CORREGIDA CON supportsAllDrives=True ---
