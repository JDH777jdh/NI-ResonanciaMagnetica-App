...
# ---------------------------------------------------------
# PASO 1: IDENTIFICACIÓN (LÓGICA CONDICIONAL CORREGIDA)
# ---------------------------------------------------------
if st.session_state.step == 1:
    ...
    if df is not None:
        # Usamos campos fuera del form para la reactividad, pero con precaución para evitar el salto
        ...
        with col1:
            ...
            # LÓGICA CONDICIONAL: Solo aparece si es No binario
            sexo_bio_in = "Masculino" # Default
        ...
        with col2:
            fecha_in = st.date_input("Fecha de Nacimiento", value=st.session_state.form["fecha_nac"], format="DD/MM/YYYY")
            email_in = st.text_input("Email de contacto", value=st.session_state.form["email"])

        # LÓGICA CONDICIONAL: Solo aparece si es menor de 18 años
        ...
        if st.button("CONTINUAR"):
            # Guardamos todo en el estado al presionar el botón
...
# ---------------------------------------------------------
# PASO 2: CUESTIONARIO COMPLETO (SIN RESUMIR)
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# PASO 3: CONSENTIMIENTO INFORMADO (TEXTO LEGAL COMPLETO)
# ---------------------------------------------------------
