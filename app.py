            ...
            if not st.session_state.form["sin_rut"] and st.session_state.mostrar_camara:
                ...
                if foto_capturada is not None:
                    with st.spinner("Procesando cédula..."):
                        ...
                        # Guardar en sesión para que los campos se rellenen
                        ...
                        st.success("✅ Datos del documento extraídos.")
                        st.rerun() # Esto obliga a la app a refrescarse para mostrar los datos
