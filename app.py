...
st.markdown(
    """
    <style>
    /* Efecto de pulso con transparencia */
    ...
    /* Estilo botones (Transparencia + Blur = Efecto Vidrio) */
    .btn-opcion {
    ...
    .btn-opcion:hover { transform: scale(1.05); background-color: rgba(255,255,255,0.1) !important; }

    /* Paleta de Colores con Transparencia (RGBA) */
    .op-wa { background-color: rgba(37, 211, 102, 0.7) !important; }   /* Verde WA */
    .op-tel { background-color: rgba(0, 86, 179, 0.7) !important; }    /* Azul Clínico */
    .op-mail { background-color: rgba(128, 0, 32, 0.7) !important; }   /* Burdeos */

    /* Botón principal (Verde esmeralda semi-claro y transparente) */
    .btn-principal {
    ...
    <div class="menu-flotante">
        <div class="opciones-contacto">
            <a class="btn-opcion op-mail" href="mailto:resonancia@cdnorteimagen.cl?subject=Consulta%20Registro%20RM" target="_blank">
