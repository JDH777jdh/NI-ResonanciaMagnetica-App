...
def render_uploaders(bloquear=False):
    # Aquí pegas tus file_uploader de antes
    st.file_uploader("Cargue la Orden Médica...", key="up_orden_p1", disabled=bloquear)
    st.file_uploader("Cargue Exámenes Anteriores...", key="up_anteriores_p1", disabled=bloquear)
