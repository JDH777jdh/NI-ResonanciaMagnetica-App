...
# --- PÁGINA 4: FINALIZACIÓN ---
    ...
    st.divider()
    st.info("⏳ Sincronizando copia digital con los servidores del hospital... Puedes descargar tu archivo mientras tanto.")
    
    # 3. CIRCUITO 1 ASÍNCRONO: BACKEND FIREBASE FIRESTORE (Si falla, no congela la pantalla)
    try:
        ...
        st.caption("🔹 Registro clínico respaldado en Base de Datos (Firestore).")
        
    except Exception as e_fb:
        # Imprime el error en la consola interna de Streamlit Cloud para auditoría sin romper la UI
        print(f"Error silencioso en segundo plano con Firestore: {e_fb}")
