...
if df is not None:
    ...
    with c1:
        ...
        # Asegúrate de que esta línea esté alineada exactamente con la de arriba
        ...
        if st.session_state.form["sin_rut"]:
            ...
            col_inputs, col_btn = st.columns([5, 1], vertical_alignment="bottom")
                col_inputs, col_btn = st.columns([5, 1], vertical_alignment="bottom")
                with col_inputs:
                    # 1. Definimos el callback local para formatear sin romper el cursor del teclado
                    ...
                    # 2. Renderizamos el campo enlazado a la sesión y al callback
                    rut_p = st.text_input(
                        "RUT del Paciente", 
                    ...
                    # 3. Resguardo de sincronización inmediata y limpieza de otros documentos
