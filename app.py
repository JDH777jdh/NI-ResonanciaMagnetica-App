...
if USAR_GOOGLE_DRIVE: 
    # Todo lo de abajo debe estar indentado un nivel a la derecha
    ...
    # 2. Si NO hay credenciales, mostrar botón de login y DETENER la app
    if st.session_state.credentials is None:
        ...
        # CRÍTICO: st.stop() queda DENTRO del IF, así que si USAR_GOOGLE_DRIVE es False,
        # la app NUNCA se detendrá aquí.
        st.stop() 
