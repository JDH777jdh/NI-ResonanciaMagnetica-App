...
# Asegúrate de que este bloque de código esté alineado con 8 espacios
        # (o el nivel correspondiente al 'try' previo)
        try:
            # ... (código previo) ...
            ...
            # CORRECCIÓN: Indentación ajustada a 12 espacios (si está dentro de un try/if)
            id_documento = f"{payload_firestore['rut']}_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
