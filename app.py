...
st.markdown(
    ...
    /* Estilo botones (Transparencia + Blur) */
    .btn-opcion {
    ...
    .btn-opcion:hover { transform: scale(1.05); background-color: rgba(255,255,255,0.2) !important; }

    /* Paleta de Colores con Transparencia (RGBA) */
    .op-wa { background-color: rgba(37, 211, 102, 0.8) !important; }   /* Verde WA */
    .op-tel { background-color: rgba(0, 86, 179, 0.8) !important; }    /* Azul Clínico */
    .op-mail { background-color: rgba(128, 0, 32, 0.8) !important; }   /* Burdeos */

    /* Botón principal (Verde esmeralda semi-claro) */
    .btn-principal {
