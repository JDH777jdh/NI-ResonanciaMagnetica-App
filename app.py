...
def generar_pdf_clinico(datos):
    ...
    pdf.set_font('Arial', '', 9)
    pdf.multi_cell(0, 5, "Existe una muy baja posibilidad de que se presente una reacción adversa al medio de contraste (0.07-2.4%) la mayoría de carácter leve fundamentalmente nauseas o cefaleas al momento de la inyección.\nPacientes con deterioro importante de la función renal, poseen riesgo de desarrollo de fibrosis nefrogénica sistémica.")
    pdf.ln(10)
...
# --- PÁGINA 3: INFORMACIÓN Y FIRMA (VERSIÓN MAXI COMPLETA) ---
elif st.session_state.step == 3:
    mostrar_logo(); st.title("Información al Paciente")
    
    st.markdown('<div class="section-header">LEA ATENTA Y CUIDADOSAMENTE:</div>', unsafe_allow_html=True)
...
# --- PÁGINA 4: FINALIZACIÓN Y SUBIDA A DRIVE ---
    ...
    # Generar el PDF con los bytes reales
