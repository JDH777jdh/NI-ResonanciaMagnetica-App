...
# ---------------------------------------------------------
# PASO 1: DATOS PERSONALES (REORDENADO)
# ---------------------------------------------------------
    ...
    if df is not None:
        ...
        with col1:
            ...
            if sin_rut:
                ...
                st.session_state.form["rut"] = "" # Limpia RUT si usa otro doc
            else:
                st.session_state.form["rut"] = formatear_rut(rut_in)
                st.session_state.form["num_doc"] = "" # Limpia doc si usa RUT

            # 4. Identidad de Género y Lógica
        ...
        # Lógica de tutor para menores (Persistente)
...
# ---------------------------------------------------------
    ...
    st.download_button(label="📥 Descargar Resumen en PDF", data=pdf_bytes, file_name=f"Registro_NorteImagen.pdf", mime="application/pdf")
