...
if st.session_state.step == 1:
    # 1. CAPTURA DE IP (Nivel Dios: Se ejecuta apenas entra el paciente)
    ip_detectada = obtener_ip() # Usamos el nombre de tu función
    if ip_detectada not in [None, "Cargando...", "0.0.0.0"]:
