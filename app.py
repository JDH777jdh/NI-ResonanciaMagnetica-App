...
# ---------------------------------------------------------
# PASO 1: IDENTIFICACIÓN (CON ST.FORM PARA EVITAR SALTOS)
# ---------------------------------------------------------
if st.session_state.step == 1:
    ...
    if df is not None:
        with st.form("form_identificacion"):
            ...
            st.markdown("---")
            st.write("Datos del Representante Legal (si corresponde):")
            c1, c2 = st.columns(2)
            ...
            submit_step1 = st.form_submit_button("CONTINUAR")
        ...
        if submit_step1:
            ...
            st.session_state.form["sexo_bio_idx"] = bio_opciones.index(sexo_bio_in)
            ...
            st.session_state.edad_para_calculo = calcular_edad(fecha_in)
...
# ---------------------------------------------------------
# PASO 3: CONSENTIMIENTO INFORMADO (TEXTO ÍNTEGRO)
# ---------------------------------------------------------
