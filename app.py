...
st.markdown("#### Condiciones o Discapacidades")
condiciones_seleccionadas = st.multiselect(
    "¿Presenta usted alguna de las siguientes condiciones o discapacidades? (Seleccione todas las que correspondan):",
    opciones_condicion
)

detalle_otra_condicion = ""
if "Otra" in condiciones_seleccionadas:
    detalle_otra_condicion = st.text_input("Detalle otra condición:")
...
# --- PÁGINA 2: CUESTIONARIO ---
    ...
    if st.session_state.tiene_contraste:
        ...
        # Usamos .get() por seguridad por si la llave aún no existe
