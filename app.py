...
# =====================================================================
# 📌 burbuja FLOTANTE DE SOPORTE TÉCNICO (Inmune a cortes de código)
# =====================================================================
st.markdown(
    """
    <style>
    ...
    /* Mostrar las opciones al pasar el mouse o mantener el foco */
    .menu-flotante-fijo:hover .opciones-contacto-fijo,
    .menu-flotante-fijo:focus-within .opciones-contacto-fijo {
        display: flex !important;
    }
    ...
    .btn-opcion-fijo:hover {
        background-color: rgba(128, 0, 32, 0.08) !important;
        color: #800020 !important;
    }

    /* La burbuja principal de color Guinda (Burgundy) */
    .burbuja-principal-fijo {
    ...
    .burbuja-principal-fijo:hover {
        transform: scale(1.04) !important;
        background-color: #990026 !important;
    }
    </style>
    
    <div class="menu-flotante-fijo" tabindex="0">
        <div class="opciones-contacto-fijo">
            <a class="btn-opcion-fijo" href="mailto:resonancia@cdnorteimagen.cl?subject=Consulta%20Registro%20RM" target="_blank">
                ✉️ resonancia@cdnorteimagen.cl
            </a>
            <a class="btn-opcion-fijo" href="tel:+56572466423" target="_blank">
                📞 Central: +56 57 246 6423
            </a>
            <a class="btn-opcion-fijo" href="https://wa.me/569XXXXXXXX" target="_blank">
                💬 WhatsApp Soporte
            </a>
        </div>
        <div class="burbuja-principal-fijo">
            ☎️ Soporte Norte Imagen
        </div>
    </div>
    """,
