                ...
                try:
                    ...
                    class PDF_Institucional(FPDF):
                        ...
                        def footer(self):
                            ...
                            # 🛠️ AJUSTE DE SEGURIDAD: Priorizamos la variable que inyectamos en el paso 1
                            ip_final = getattr(self, 'p_ip', 'IP No detectada')
    
                            # Si sigue vacía, buscamos en el diccionario completo
                            if ip_final == "IP No detectada" and hasattr(self, 'datos_doc'):
                            # IMPORTANTE: Aquí debe coincidir con la llave 'ip_paciente' que guardamos en app.py
                    ...
                    # =====================================================================
                    # 📥 ¡AQUÍ SE INYECTAN LAS VARIABLES AL OBJETO PARA EL FOOTER!
                    # =====================================================================
                    pdf.datos_doc = datos_doc              # Envía el diccionario completo por si acaso
                    pdf.p_nombre = paciente_nombre          # Requerido por tu footer para las iniciales
                    pdf.p_rut = paciente_rut                # Requerido por tu footer
                    pdf.p_ip = ip_cliente                  # 🔥 ¡Aquí se le pasa la IP limpia al footer!
                    pdf.f_val = fecha_validacion_str       # Requerido por tu footer para la fecha de RM
                    # =====================================================================
