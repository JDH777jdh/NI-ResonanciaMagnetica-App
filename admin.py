...
def filtrar_y_sincronizar_pacientes():
    ...
    # 2. Control de flujo: Si no hay pacientes
    if not listado_pacientes:
        ...
        return # Salimos de la función, no dibujamos nada más

    # 3. SI HAY PACIENTES: Crear el selector (Esto va ANTES de la visualización)
    ...
    # 4. Actualizar sesión al cambiar el selector
    ...
    # 5. RENDERIZADO: Mostrar la ficha del paciente seleccionado
    ...
    if datos_doc:
        ...
        with c1:
            ...
            # ... resto de tu código de visualización (Params, etc) ...
        with c2:
            st.markdown("#### 🚨 Bioseguridad")
            # ... resto de tu código de c2 ...
    else:
        st.info("👈 Selecciona un paciente de la lista para ver su ficha.")
