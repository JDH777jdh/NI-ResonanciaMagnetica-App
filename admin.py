...
with c2:
    ...
    with st.expander("💉 7. REGISTRO DE ADMINISTRACIÓN DE CONTRASTE", expanded=True):
        ...
        lista_medios_disponibles = [
            ...
            "Contraste neutro (H2O)", "Suero fisiológico (NaCl 0,9%)", "Betametasona",
            "Clorfenamina Maleato", "Butilbromuro de Escopolamina (Buscapina)", "Furosemida",
        ...
        otros_meds = st.text_input("Otros medicamentos adicionales u observaciones):")
