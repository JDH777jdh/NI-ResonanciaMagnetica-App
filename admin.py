            ...
            if tiene_implantes:
                ...
                for implante in lista_implantes:
                    ...
                    if st.session_state[key_estado]:
                        st.success(f"✅ Clasificación asignada: **{st.session_state[key_estado]}**")
                    else:
    ...
    with c2:
        ...
        with st.expander("🧪 6. EVALUACIÓN DE LA FUNCIÓN RENAL", expanded=True):
            ...
            if peso_profesional > 0 and creatinina_profesional > 0:
                ...
                # 🚀 1. EXTRACCIÓN BLINDADA DE EDAD (Filtra solo los números, ignorando palabras como "años")
                ...
                # 🚀 2. EXTRACCIÓN BLINDADA DE SEXO/GÉNERO
                ...
                # 🚀 3. CÁLCULO COCKCROFT-GAULT
                try:
                    vfg_bruto = ((140 - edad_paciente) * peso_profesional) / (72 * creatinina_profesional) * factor_sexo
                    vfg_dinamico = round(vfg_bruto, 2) # Limitamos a dos decimales de inmediato
            ...
            # 5. Renderizado visual HTML (Ordenado: Peso -> Creatinina -> VFG)
            st.markdown(f"""
