        ...
        if canvas_profesional is not None and canvas_profesional.json_data is not None and len(canvas_profesional.json_data["objects"]) > 0:
            with st.spinner("Estampando firma del profesional y consolidando documento..."):
                try:
                    ...
                    # Mapeo manual para asegurar que el mes salga en español y mayúsculas sin depender del idioma del servidor
meses_es = {1: "ENERO", 2: "FEBRERO", 3: "MARZO", 4: "ABRIL", 5: "MAYO", 6: "JUNIO", 
            7: "JULIO", 8: "AGOSTO", 9: "SEPTIEMBRE", 10: "OCTUBRE", 11: "NOVIEMBRE", 12: "DICIEMBRE"}

ahora = datetime.now(tz_chile)
nombre_limpio = paciente_nombre_val.replace(" ", "-").upper()
mes_texto = meses_es[ahora.month]
anio_texto = ahora.strftime('%Y')

st.session_state.pdf_filename = f"REG-VALIDADO_{nombre_limpio}_{paciente_rut}_{mes_texto}_{anio_texto}.pdf"
