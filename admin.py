...
if datos_doc:
    ...
    # --- A. FICHA DE ATENCIÓN CLÍNICA ---
        ...
        # 💡 DECODIFICACIÓN EXACTA BASADA EN LOS ÍNDICES DE app.py
        ...
        if idx_gen == "1":
            ...
            sexo_paciente = "Masculino" # Default 0
        ...
        with sub_c2:
            ...
            # Insertamos un salto vacío para mantener la simetría de las columnas
            st.write("** **\n** **") 
