...
def filtrar_y_sincronizar_pacientes():
    ...
    # 1. Intento de lectura de Firebase
    try:
    ...
    # 2. Control de flujo: Si no hay pacientes, limpiamos y salimos (Early Return)
    ...
    # 3. Si hay pacientes, procedemos a mostrar el selector
    ...
    # 4. Carga de datos del paciente seleccionado
